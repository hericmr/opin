...
const DataCard = ({ icon: Icon, label, value, wide = false, searchTag = false }) => {
  ...
  return (
    <div className={`bg-white rounded-xl px-5 py-4 flex items-start gap-4 ${wide ? 'col-span-2' : ''}`}>
      <div className="w-14 h-14 rounded-full bg-green-50 flex items-center justify-center flex-shrink-0 mt-0.5">
