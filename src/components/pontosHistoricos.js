const pontoshistorico = [
  {
    lat: -23.9851111,
    lng: -46.3088611,
    desc: "Estátua de Iemanjá - Rainha do Mar",
    tipo: "historico",
    detalhes: {
...
A estátua de Iemanjá, localizada na Praia do José Menino, é um dos símbolos da força e presença afro-brasileira em Santos. Sua instalação na orla da praia foi uma conquista dos movimentos negros da região, após permanecer guardada no Teatro Municipal de Santos por vários anos.
      ...
      video: "",
      imagens: [
        "/cartografiasocial/fotos/yemanja.png"
      ],
      links: [
        {
          texto: "Levante vai cobrar Estátua de Iemanjá em Santos - DL",
          url: "https://www.diariodolitoral.com.br/cotidiano/levante-vai-cobrar-estatua-de-iemanja-em-santos/136502/; Prometida estátua de Iemanjá não entregue em Santos - BoqNews: https://www.boqnews.com/cidades/prometida-estatua-de-iemanja-nao-e-entregue-em-santos/"
        }
      ]
    }
  },
  {
    ...
    detalhes: {
      ...
      video: "",
      imagens: [
        "/cartografiasocial/fotos/ponte.png"
      ],
      links: [
        {
  ...
  },
  {
    ...
    detalhes: {
      ...
      links: [
        {
          texto: "Fonte",
          url: "Santos FC: https://www.santosfc.com.br/zito-o-eterno-capitao-do-santos/"
        }
      ]
    }
  },
  {
    ...
    detalhes: {
      ...
      links: [
        {
          texto: "Fonte",
          url: "Prefeitura de Santos: https://www.santos.sp.gov.br"
        }
      ]
    }
  },
  {
    ...
    detalhes: {
      ...
      descricao: `É uma empresa que oferece roteiros sobre Afroturismo, que tem como objetivo apresentar um percurso, pensado e elaborado para visibilizar e valorizar as histórias de personalidades negras, assim como fatos e lugares de grande relevância histórica desde o período da escravização assim como   fatos e personagens que se relacionam à história da contribuição da população negra para a construção da Santos atual.
Telefone:  (13) 97805-7000
Instagram: @ mochilandoafroculturas
`,
      video: "",
      imagens: [],
      links: []
  ...
  },
  {
    ...
    detalhes: {
      ...
      video: "",
      imagens: [
        "/cartografiasocial/fotos/quilombo_1.jpg",
        "/cartografiasocial/fotos/quilombo_2.jpg"
      ],
      links: []
    }
  }
...
export default pontoshistorico;
