...
const DadosBasicosTab = ({ editingLocation, setEditingLocation }) => {
  return (
    <div className="space-y-8">
      ...
      {/* Seção: Informações Principais - Estilo WhatsApp Dark Mode */}
      <div className="bg-[#202C33] rounded-lg p-6 mb-6 border border-[#2A3942]">
        <h3 className="text-base font-semibold text-[#E9EDEF] mb-6 flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="lg:col-span-2">
            ...
            <input
              type="text"
              className="w-full border border-[#2A3942] bg-[#111B21] rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-[#00A884] focus:border-[#00A884] text-[#E9EDEF] placeholder-[#8696A0] transition-all duration-200"
