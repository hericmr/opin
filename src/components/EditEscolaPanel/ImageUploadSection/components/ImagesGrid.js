      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {images.map((image, index) => (
          <ImageCard
            ...
            onDelete={onDelete}
            onReplace={onReplace}
            onSetHeader={headerImage?.setHeaderImage || undefined}
            onRemoveHeader={headerImage?.removeHeaderImage || undefined}
            onAddDrawing={drawingsImage?.addDrawingImage || undefined}
            onRemoveDrawing={drawingsImage?.removeDrawingImage || undefined}
